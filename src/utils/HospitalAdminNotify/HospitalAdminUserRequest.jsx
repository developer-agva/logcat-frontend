                                                        ...
                                                        <div className="text-center">
                                                            ...
                                                            <div className="flex justify-center gap-4">
                                                                <button style={{ backgroundColor: 'red', color: 'white', padding: '10px', borderRadius: '8px' }} onClick={() => {
                                                                    dispatch(postRequestActionByHospitalAdmin({ isAssigned: 'Accepted', userId: item.userId, deviceId: item.deviceId }))
                                                                    setTimeout(() => {
                                                                        setOpenModal(false)
                                                                    }, 1000);
                                                                }}>
                                                ...
                                                <Modal show={openModalReq} size="md" onClose={() => setOpenModalReq(false)} popup>
                                                    ...
                                                    <Modal.Body>
                                                        <div className="text-center">
                                                            ...
                                                            <div className="flex justify-center gap-4">
                                                                <button style={{ backgroundColor: 'red', color: 'white', padding: '10px', borderRadius: '8px' }} onClick={() => {
                                                                    dispatch(postRequestActionByHospitalAdmin({ isAssigned: 'Rejected', userId: item.userId, deviceId: item.deviceId }))
                                                                    setTimeout(() => {
