...
import { getSingleServicesDataAction, getVerifiedOtpServiceAction, sendTicketStatusDataAction } from '../store/action/ServiceEngAction';
...
function SingleServicesData() {
    ...
    const postTicketStatusReducer = useSelector((state) => state.postTicketStatusReducer);
    const { message } = postTicketStatusReducer;
    ...
    const handleSubmit = useCallback((e) => {
        e.preventDefault()
        // dispatch(getOtpForTicketServicesAction(deviceId))
    ...
    const handleAddTicket = (e) => {
        ...
        // // }
        // else if(!issuesData?.description){
        //     toast.error('Enter Description')
        // }
        // else if (!issuesData.name && issuesData.email && issuesData.wardNo && issuesData.contactNo && issuesData.hospitalName && issuesData.department&& issuesData.description) {
        dispatch(sendTicketStatusDataAction({
            deviceId: deviceId,
            date: date,
            message: newCheckedValue,
            ...
            remark: issuesData?.description,
            date: issuesData?.date
        }))
        setTimeout(() => {
            setOpenModal('pop-up')
        }, 1000);
                                                                        ...
                                                                        <div className="space-y-6">
                                                                            ...
                                                                            <div style={{ display: 'flex', padding: '5px', justifyContent: 'space-between' }}>
                                                                                ...
                                                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                                                                    <div>
                                                                                        <lable class="block mb-2 text-sm font-medium text-gray-900">Name</lable>
                                                                                        <p>
                                                                                            {singleData.name}
                                                                                        </p>
                                                                                    </div>
                                                                                    <div>
                                                                                        <lable class="block mb-2 text-sm font-medium text-gray-900">Email</lable>
                                                                                        <p>
                                                                                            {singleData.email}
                                                                                        </p>
                                                                                    </div>
                                                                                ...
                                                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                                                                    <div>
                                                                                        <lable class="block mb-2 text-sm font-medium text-gray-900">Contact Number</lable>
                                                                                        <p>
                                                                                    ...
                                                                                    <div>
                                                                                        <lable class="block mb-2 text-sm font-medium text-gray-900">Hospital Name</lable>
                                                                                        <p>
                                                                                    ...
                                                                                    <div>
                                                                                        <lable class="block mb-2 text-sm font-medium text-gray-900">Department</lable>
                                                                                        <p>
                                                                ...
                                                                <Modal.Body>
                                                                    <div className="text-center">
                                                                        <div class="mb-6">
                                                                            ...
                                                                            <label for="large-input" class="block mb-2 text-sm font-medium text-gray-900 dar">Enter OTP Code</label>
                                                            ...
                                                            <Modal show={props.openModal == 'defaultAdd'} onClose={() => props.setOpenModal(undefined)}>
                                                                ...
                                                                <Modal.Body>
                                                                    <div className="space-y-6">
                                                                            ...
                                                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                                                                <div>
                                                                                    ...
                                                                                    <input id='arrow' onChange={(e) => setIssuesData({ ...issuesData, name: e.target.value })} value={issuesData.name}
                                                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 " placeholder="Enter Name" required />
                                                                                </div>
                                                                                <div>
                                                                                    <lable class="block mb-2 text-sm font-medium text-gray-900">Email</lable>
                                                                                    <input id='arrow' onChange={(e) => setIssuesData({ ...issuesData, email: e.target.value })} value={issuesData.email}
                                                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 " placeholder="Enter Email" required />
                                                                                </div>
                                                                                <div>
                                                                                    <lable class="block mb-2 text-sm font-medium text-gray-900">Ward No.</lable>
                                                                                    <input id='arrow' onChange={(e) => setIssuesData({ ...issuesData, wardNo: e.target.value })} value={issuesData.wardNo}
                                                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 " placeholder="Enter Ward Number" required />
                                                                                </div>
                                                                                <div>
                                                                                    <lable class="block mb-2 text-sm font-medium text-gray-900">Service Issued from</lable>
                                                                                    <input type='text' onChange={(e) => setIssuesData({ ...issuesData, issuedFrom: e.target.value })} value={issuesData.issuedFrom}
                                                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 " placeholder="Service Issued From" required />
                                                                                </div>
                                                                            </div>
                                                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                                                                <div>
                                                                                    ...
                                                                                    <input id='arrow' onChange={(e) => setIssuesData({ ...issuesData, contactNo: e.target.value })} value={issuesData.contactNo}
                                                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 " placeholder="Enter Contact Number" required />
                                                                                </div>
                                                                                <div>
                                                                                    <lable class="block mb-2 text-sm font-medium text-gray-900">Hospital Name</lable>
                                                                                    <input id='arrow' onChange={(e) => setIssuesData({ ...issuesData, hospitalName: e.target.value })} value={issuesData.hospitalName}
                                                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 " placeholder="Enter Hospital Name" required />
                                                                                </div>
                                                                                <div>
                                                                                    <lable class="block mb-2 text-sm font-medium text-gray-900">Department</lable>
                                                                                    <input id='arrow' onChange={(e) => setIssuesData({ ...issuesData, department: e.target.value })} value={issuesData.department}
                                                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 " placeholder="Enter Department Name" required />
                                                                                </div>
                                                                                <div>
                                                                                    <lable class="block mb-2 text-sm font-medium text-gray-900">Date</lable>
                                                                                    <input type='date' id='arrow' onChange={(e) => setIssuesData({ ...issuesData, date: e.target.value })} value={issuesData.date}
                                                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 " placeholder="Enter Department Name" required />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div>
                                                                            <lable class="block mb-2 text-sm font-medium text-gray-900">Description</lable>
                                                                            <textarea onChange={(e) => setIssuesData({ ...issuesData, description: e.target.value })} value={issuesData.description}
                                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 " placeholder="Enter Description" required />
                                                                        </div>
                                                                    </div>
