...
export const getPatientDetailsOfNewDevicesByUhid = (deviceid) => async (dispatch) => {
  try {
    dispatch({
...
export const postLockToDeviceIdAction =
  ({ DeviceId, isPaymentDone, isLocked }) => async (dispatch) => {
    try {
      dispatch({
...
export const getIndianMedicineAction =
...
export const addMedicineIllnessAction =
  ({ UHID, diagnoseData, medicineData }) => async (dispatch) => {
    try {
      dispatch({
...
export const postEndDateAction =
  ({illnessId, UHID, endDate,medicineId}) => async (dispatch) => {
    try {
      dispatch({
