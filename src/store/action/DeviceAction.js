...
export const newDeviceAction =
  ...
  async (dispatch) => {
    try {
      ...
      let response;
      response = await axios.get(
        `${process.env.REACT_APP_BASE_URL}/api/logger/logs/v2/AllEvents/Events/${projectCode}?search=${searchData}&page=${page}&limit=${limit}`,
        config
      );
      dispatch({
...
export const getSingleDeviceIdDetails = (DeviceId,projectCode) => async (dispatch) => {
  try {
    dispatch({
    ...
    let { data } = await axios.get(
     projectCode?`${process.env.REACT_APP_BASE_URL}/devices/getdevice/v2/${DeviceId}`: `${process.env.REACT_APP_BASE_URL}/devices/getdevice/${DeviceId}`,
      config
    );
    dispatch({
...
export const getDeveloperOptionData = ({page,limit,did}) => async (dispatch) => {
  try {
    dispatch({
...
export const getDeviceEventsById =
  ...
  async (dispatch) => {
    try {
      ...
      response = await axios.get(
        projectCode?`${process.env.REACT_APP_BASE_URL}/api/logger/logs/v2/deviceEvents/${DeviceId12}?page=${page}&limit=${limit}&startDate=${startDatee}&endDate=${endDatee}&search=${searchh}`: `${process.env.REACT_APP_BASE_URL}/api/logger/logs/deviceEvents/${DeviceId12}?page=${page}&limit=${limit}&startDate=${startDatee}&endDate=${endDatee}&search=${searchh}`,
        config
      );
      dispatch({
...
export const getCalibrationById =
  ...
  async (dispatch) => {
    try {
      ...
      response = await axios.get(
        projectCode?`${process.env.REACT_APP_BASE_URL}/api/logger/logs/v2/calibration/${DeviceId12}?page=${page}&limit=${limit}`:`${process.env.REACT_APP_BASE_URL}/api/logger/logs/calibration/${DeviceId12}?page=${page}&limit=${limit}`,
        config
      );
      dispatch({
...
export const getDeviceAlarmsById =
  ...
  async (dispatch) => {
    try {
      ...
      const startDatee = startDate == undefined ? "" : startDate=='NaN-NaN-NaN'?'':startDate;
      const endDatee = endDate == undefined ? "" : endDate=='NaN-NaN-NaN'?'':endDate;
      let searchh = search == undefined ? "" : search;
      ...
      let response;
      response = await axios.get(
        projectCode?`${process.env.REACT_APP_BASE_URL}/api/logger/logs/v2/deviceAlerts/${DeviceId121}?page=${page}&limit=${limit}&startDate=${startDatee}&endDate=${endDatee}&search=${searchh}`: `${process.env.REACT_APP_BASE_URL}/api/logger/logs/deviceAlerts/${DeviceId121}?page=${page}&limit=${limit}&startDate=${startDatee}&endDate=${endDatee}&search=${searchh}`,
        config
      );
      dispatch({
...
export const getDeviceLogsById =
  ...
  async (dispatch) => {
    try {
      ...
      response = await axios.get(
        projectCode?`${process.env.REACT_APP_BASE_URL}/api/logger/logs/v2/deviceLogs/${DeviceId121}?page=${page}&limit=${limit}`: `${process.env.REACT_APP_BASE_URL}/api/logger/logs/deviceLogs/${DeviceId121}?page=${page}&limit=${limit}`,
        config
      );
      dispatch({
...
// trends data
export const getDeviceTrendsById = ({startDatee,endDatee}) => async (dispatch) => {
  try {
    dispatch({
    ...
    response = await axios.get(
      projectCode? `${process.env.REACT_APP_BASE_URL}/api/logger/logs/v2/deviceTrends/${DeviceId12}?startDate=${startDate}&endDate=${endDate}`:`${process.env.REACT_APP_BASE_URL}/api/logger/logs/deviceTrends/${DeviceId12}?startDate=${startDate}&endDate=${endDate}`,
...
export const postLockToDeviceIdAction =
  ({ DeviceId, isPaymentDone, isLocked }) =>
  async (dispatch) => {
    try {
      dispatch({
      ...
      const { data } = await axios.put(
        `${process.env.REACT_APP_BASE_URL}/devices/payment-update`,
        {
          DeviceId,
          isPaymentDone,
          isLocked,
