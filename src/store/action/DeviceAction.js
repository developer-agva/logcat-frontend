...
export const getDeviceEventsById =
  ...
  async (dispatch) => {
    try {
      ...
      response = await axios.get(
        projectCode?`${process.env.REACT_APP_BASE_URL}/api/logger/logs/v2/deviceEvents/${DeviceId12}?page=${page}&limit=${limit}&startDate=${startDatee}&endDate=${endDatee}&search=${search}`: `${process.env.REACT_APP_BASE_URL}/api/logger/logs/deviceEvents/${DeviceId12}?page=${page}&limit=${limit}&startDate=${startDatee}&endDate=${endDatee}&search=${search}`,
        config
      );
      dispatch({
...
export const getDeviceAlarmsById =
  ...
  async (dispatch) => {
    try {
      ...
      let response;
      response = await axios.get(
        projectCode?`${process.env.REACT_APP_BASE_URL}/api/logger/logs/v2/deviceAlerts/${DeviceId121}?page=${page}&limit=${limit}&startDate=${startDatee}&endDate=${endDatee}&search=${search}`: `${process.env.REACT_APP_BASE_URL}/api/logger/logs/deviceAlerts/${DeviceId121}?page=${page}&limit=${limit}&startDate=${startDatee}&endDate=${endDatee}&search=${search}`,
        config
      );
      dispatch({
...
export const getDeviceTrendsById = (startDatee,endDatee) => async (dispatch) => {
  try {
    ...
    response = await axios.get(
      projectCode? `${process.env.REACT_APP_BASE_URL}/api/logger/logs/v2/deviceTrends/${DeviceId12}&startDate=${startDatee}&endDate=${endDatee}`:`${process.env.REACT_APP_BASE_URL}/api/logger/logs/deviceTrends/${DeviceId12}&startDate=${startDatee}&endDate=${endDatee}`,
