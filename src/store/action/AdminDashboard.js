...
export const getSoldDemoDataAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_BASE_URL}/devices/get-device-count`,
      config
    );
    dispatch({
...
export const getDoctorAccessListAction = () => async (dispatch) => {
  try {
    dispatch({
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_BASE_URL}/api/logger/logs/get-device-access-doct-list`,
      config
    );
    dispatch({
...
export const removeDoctorAccessListAction = (_id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${process.env.REACT_APP_BASE_URL}/api/logger/`,
      config
    );
    dispatch({
