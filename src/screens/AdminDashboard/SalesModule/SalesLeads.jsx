...
const SalesLeads = () => {
    ...
    return (
        <>
            ...
            {loading && (
                <div className=" flex justify-center items-center bg-gray-50 bg-opacity-80">
                    <div className="flex flex-col items-center">
                        <svg className="animate-spin h-10 w-10 text-gray-600" viewBox="0 0 24 24">
                            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0l4 4-4 4V6a6 6 0 00-6 6H4z"></path>
                        </svg>
                        <span className="mt-2 text-gray-600 text-lg">Loading...</span>
                    </div>
                </div>
            )}
                                ...
                                {loading ? (
                                    ...
                                    filteredData?.map((lead, index) => (
                                        <tr key={index} className="text-gray-700 border-t border-gray-300 text-sm">
                                            ...
                                            <td className="p-3">{lead.saleAmount || "---"}</td>
                                            <td className="p-3">{lead.quantity || "---"}</td>
                                            <td className="p-3">
                    ...
                    {showAddLead && (
                        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                            <div className="bg-white p-6 shadow-lg rounded-lg w-full max-w-4xl relative">
                                ...
                                <AddLeadForm salesLeadData={updateLeadData} updateLeadStatus={updateLeadStatus} />
