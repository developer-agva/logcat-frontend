...
const AddLeadForm = ({ salesLeadData, updateLeadStatus }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (updateLeadStatus) {
            dispatch(editSalesLeadAction(formPayload));
        } else {
            ...
            >
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div>
                            <label htmlFor="device" className="block mb-2 text-sm font-medium text-gray-900">Device</label>
                            <select
                                name="device"
                        ...
                        <div>
                            ...
                            <div className="flex flex-column gap-2">
                                ...
                                <button type="button" onClick={generatePdfAndUploadToS3} class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-white focus:outline-none bg-pink-700 rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-black focus:z-10 focus:ring-4 focus:ring-gray-100">Upload</button>
                            </div>
                        </div>
                    </div>
                </div>
