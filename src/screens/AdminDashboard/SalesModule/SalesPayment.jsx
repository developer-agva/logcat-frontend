            ...
            {filteredPayments?.map((payment, index) => {
              return (
                <tr key={index} className="text-gray-700 border-t border-gray-300 text-sm">
                  ...
                  <td className="p-4">{payment.sales?.[0]?.paymentTerms || '--'}</td>
                  <td className="p-4">{payment.sales?.[0]?.remarks || '--'}</td>
                  <td className="p-3">
                  ...
                  <td className="p-4">
                    {payment.paymentUpdates?.[0]?.remainingAmount === "0" ?
                      ...
                      }} className="bg-pink-600 text-white px-3 py-1 rounded-lg">UPDATE</button>
                    }
                  </td>
                </tr>
              );
