...
const AdminDashboard = () => {
  ...
  console.log('111', activeDemoDeviceData)
  ...
  const activeDemoDevicesDataClick = (e) => {
    ...
    // if (activeDemoDevice == "weekly") {
    //   const newResults = activeDeviceName.map((weekNumber) => {
    //     // Calculate the start date of the given week number
    //     const startOfYear = new Date(year, 0, 1);
    //     const startOfGivenWeek = addWeeks(startOfISOWeek(startOfYear), weekNumber - 1);

    //     // Get the month name
    //     const monthName = format(startOfGivenWeek, 'MMMM');

    //     // Calculate the start of the month
    //     const startOfMonth = new Date(year, startOfGivenWeek.getMonth(), 1);

    //     // Calculate the week number in the month
    //     const weekOfMonth = differenceInCalendarWeeks(startOfGivenWeek, startOfMonth) + 1;
    ...
    // }
    // else if (activeDemoDevice == "monthly") {
  ...
  var rana = totalDemoState == "monthly"
    ...
    : totalDemoState == "yearly" ? deviceDemo?.totalDevicesCountYearly : totalDemoState === "yearly" ? deviceDemo?.totalDevicesCountWeekly : deviceDemo?.todayActiveDeviceCount;
  ...
  const activeDeviceValues = totalActiveDeviceData && totalActiveDeviceData.map((item) => item.count);
  const activeDeviceName = totalActiveDeviceData && totalActiveDeviceData.map((item) => item.duration);
  ...
  const options = {
    scales: {
      y: {
        ...
        suggestedMax: 150, // Set the maximum value for the y-axis
      },
    },
  };
        ...
        >
          ...
          >
            <div className="line_chart">
              ...
              {!loading && <LineChart _id='lineCharthai' chartData={data} className="lineChart_data" options={options} />}
            ...
            <div className="line_chart">
              ...
              {!loading2 && <LineChart chartData={activeData} className="lineChart_data" options={options} />}
              {!loading2 &&
        ...
        >
          ...
          >
            <div className="line_chart">
              ...
              {!loading3 && <LineChart chartData={demoData} className="lineChart_data" options={options} />}
