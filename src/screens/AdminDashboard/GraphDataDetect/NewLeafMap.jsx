...
const StreetMap = ({ pincodes }) => {
  ...
  return (
    <div style={{ height: '350px', width: '100%' ,display:'flex',alignItems:'end',flexDirection:'column'}}>
      <button onClick={handleClick} style={{ padding: '8px', backgroundColor: 'black', color: 'white', margin: '2px', borderRadius: '8px',marginBottom:'-2rem',zIndex:'22',marginRight:'4px'}}>
        <FiRefreshCw />
      </button>
      <MapContainer center={[20.5937, 78.9629]} zoom={5} style={{ height: '100%', width: '100%',position:'sticky' }}>
        <TileLayer
