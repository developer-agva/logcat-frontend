                                    ...
                                    {singleData && singleData.map((item1, index) => {
                                        return (
                                            <tr class="bg-white border-b hover:bg-gray-50">
                                                ...
                                                <td class="px-6 py-4 text-center">
                                                <button onClick={()=>{history(`/previousHistoryModalData?deviceId=${item1.deviceId}&serialNo=${item1.serial_no}`)}} style={{ width: '5vw', padding: '0.5rem', backgroundColor: 'rgb(152, 0, 76)', color: 'white', borderRadius: '5px' }}>More</button>
                                                </td>
                                            </tr>
                                        )
                                    })}
