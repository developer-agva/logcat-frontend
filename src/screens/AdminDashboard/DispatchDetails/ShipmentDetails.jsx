                                ...
                                <section style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    ...
                                    <fieldset className="flex max-w-md flex-row gap-4">
                                        <div className="flex items-center gap-2">
                                            <Radio id="Car" name="countries" value="Car" onChange={e => setShipperState(e.target.value)} />
                                            <Label htmlFor="Car">Car</Label>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <Radio id="Truck" name="countries" value="Truck" onChange={e => setShipperState(e.target.value)} />
                                            <Label htmlFor="Truck">Truck</Label>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <Radio id="Train" name="countries" value="Train" onChange={e => setShipperState(e.target.value)} />
                                            <Label htmlFor="Train">Train</Label>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <Radio id="Air" name="countries" value="Air" onChange={e => setShipperState(e.target.value)} />
