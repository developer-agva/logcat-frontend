            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <button onClick={()=>history(`/AccountEditDetails?serialNumber=${serialNumber}`)} style={{backgroundColor:'rgb(152, 0, 76)',color:'white',padding:'0.5rem',borderRadius:'12px',width:'5rem'}}>
                        Edit
                        </button>
                    </div>
                    {/* Details */}
