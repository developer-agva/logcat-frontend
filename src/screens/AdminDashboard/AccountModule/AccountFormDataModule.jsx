                                ...
                                >
                                    <form className='flex flex-wrap' style={{gap:'2rem'}}>
                                        ...
                                        <div className="w-full flex flex-col gap-4">
                                            <form class="w-full">
                                                <div class="mb-2">
                                                    <label for="invoice" class="text-start block mb-2 text-sm font-medium text-gray-900 dark:text-white">IRN Number</label>
                                                ...
                                                <div class="mb-2">
                                                    <label for="invoice" class="text-start block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ack Number</label>
                                                    <input type="text" onChange={(e) => {
                                                ...
                                                <div class="mb-2">
                                                    <label for="invoice" class="text-start block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ack Date</label>
                                                ...
                                                <div class="mb-2">
                                                    <label for="invoice" class="text-start block mb-2 text-sm font-medium text-gray-900 dark:text-white">Consignee Name</label>
                                                    <input type="text" onChange={(e) => {
                                                ...
                                                <div class="mb-2">
                                                    <label for="invoice" class="text-start block mb-2 text-sm font-medium text-gray-900 dark:text-white">Consignee Address</label>
                                                    <input type="text" onChange={(e) => {
                                                ...
                                                <div class="mb-2">
                                                    <label for="invoice" class="text-start block mb-2 text-sm font-medium text-gray-900 dark:text-white">Invoice / Document Number <span>*</span></label>
                                                    <input type="text" onChange={(e) => {
