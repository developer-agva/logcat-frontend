...
function AccountFormDataModule() {
    ...
    const handleSubmitData = (e) => {
        ...
        else if(!accountData.irnNumber){
            toast.error('Enter IRN Number')
        }
        else if(!accountData.ackNumber){
            toast.error('Enter Ack Number')
        }
        else if(!accountData.ackDate){
            toast.error('Enter Ack Date')
        }
        else if (accountData.billedTo && accountData.ackNumber && accountData.ackDate && accountData.irnNumber && accountData.document_ref_no && accountData.ewayNumber && accountData.invoiceNumber) {
