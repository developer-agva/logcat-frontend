...
function AccountAllDataModule() {
  ...
  const { loading, data } = getAccountDataReducer;
                      ...
                      {records && records.map((item1, index) => {
                        return (
                          <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-left">
                              <button onClick={() => { history(`/singleAccountData?serialNumber=${item1.serialNo}`) }} style={{ padding: '8px', width: '5rem', backgroundColor: 'rgb(203, 41, 123)', color: 'white', borderRadius: '8px' }} >More</button>
                            </td>
                          </tr>
                        )
                      })}
