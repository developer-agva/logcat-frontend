                                                ...
                                                <tr class="bg-white border-b hover:bg-gray-50">
                                                    ...
                                                    <td class="px-6 py-4 text-left">
                                                        {item1.shipmentMode === 'req_doc' ?
                                                            ...
                                                            }} style={{ textDecoration: 'none', backgroundColor: 'rgb(152, 0, 76)', color: 'white', padding: '10px', width: '7vw', borderRadius: '5px' }}>
                                                                Request Doc.
                                                            </button>
                                                            :
                                                            item1.shipmentMode === 'inprocess' ?
                                                                <button onClick={() => { history(`/accountFormModule?serialNo=${item1.serialNumber}`) }} style={{ textDecoration: 'none', backgroundColor: 'rgb(152, 0, 76)', color: 'white', padding: '10px', width: '7vw', borderRadius: '5px' }}>
                                                                    Upload Data
                                                                </button>
                                                                :
                                                                <button onClick={() => { history(`/accountFormModule?serialNo=${item1.serialNumber}`) }} style={{ textDecoration: 'none', backgroundColor: 'rgb(152, 0, 76)', color: 'white', padding: '10px', width: '7vw', borderRadius: '5px' }}>
