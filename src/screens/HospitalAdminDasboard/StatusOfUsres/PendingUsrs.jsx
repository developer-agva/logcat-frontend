                            ...
                            <div className="text-center">
                              ...
                              <div className="flex justify-center gap-4">
                                <button style={{ backgroundColor: 'red', color: 'white', padding: '10px', borderRadius: '8px' }} onClick={() => {
                                  dispatch(appDisapprovePendingDataAction({ accountStatus: 'Active', _id: item._id }))
                                  setTimeout(() => {
                                    setOpenModal(false)
                                  }, 1000);
                                  // toast.success('Accept User Succesfully')
                                }}>
                                  Yes, I'm sure
                                </button>
                        ...
                        <Modal show={openModalRej} size="md" onClose={() => setOpenModalRej(false)} popup>
                          ...
                          <Modal.Body>
                            <div className="text-center">
                              ...
                              <div className="flex justify-center gap-4">
                                <button style={{ backgroundColor: 'red', color: 'white', padding: '10px', borderRadius: '8px' }} onClick={() => {
                                  dispatch(appDisapprovePendingDataAction({ accountStatus: 'Inactive', _id: item._id }))
