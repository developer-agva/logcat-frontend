            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {registerUsers && registerUsers.length > 0 ?
                    ...
                    return (
                      <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-center ">
                          ...
                          }} style={{ backgroundColor: 'rgb(203, 41, 123)', color: 'white', padding: '10px', borderRadius: '5px' }}>Review</button>
                        </td>
                        <Modal show={openModal} onClose={() => setOpenModal(false)}>
                          <h4 style={{ padding: '1rem', color: 'gray' }}>Review</h4>
                          <hr />
                          <Modal.Body>
                          ...
                          <Modal.Footer style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <Button onClick={() => {
                            dispatch(appDisapprovePendingDataAction({ accountStatus: 'Active', _id: active_Id } ))
                  ...
                  :
                  <section >
                    {registerUsers && registerUsers.length == 0 && (<div style={{ height: '30vh', position: 'relative', left: '32rem', top: '6rem' }}>
                      <span>
                        Loading...
                      </span>
                    </div>)}
