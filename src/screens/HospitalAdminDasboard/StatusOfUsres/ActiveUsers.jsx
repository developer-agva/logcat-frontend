...
function ActiveUsers() {
  ...
  const { loading, data, error } = activeUsersReducer;
                    ...
                    return (
                      <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-center ">
                          <button onClick={() => {
                            // setOpenModal(true)
                            // setActiveData(item._id)
                            history(`/allAccessDeviceToUser?_id=${item._id}`)
                          }} style={{ backgroundColor: 'rgb(152, 0, 76)', color: 'white', padding: '10px',width:'80px', borderRadius: '5px' }}> More </button>
                        </td>
                        {/* <td class="px-6 py-4 text-center ">
                          <button onClick={() => {
                            setOpenModal(true)
                            setActiveData(item._id)
                          }} style={{ backgroundColor: 'rgb(152, 0, 76)', color: 'white', padding: '10px', borderRadius: '5px' }}>Remove</button>
                        </td> */}
