            ...
            >
                <div style={{ display: 'flex', gap: '2rem' }}>
                    <Link to='/hospitalAdminUser' style={{ textDecoration: 'none' }}>
                        <div style={{ boxShadow: 'rgba(0, 0, 0, 0.16) 0px 0px 50px', backgroundColor: 'white', color: 'black', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '1rem', width: '13rem', height: '8rem', textAlign: 'center', borderRadius: '15px' }}>
