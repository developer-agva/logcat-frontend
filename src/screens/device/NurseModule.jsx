                                    ...
                                    return (
                                        <tbody>
                                            <tr class="bg-white border-b :bg-gray-800 :border-gray-700" key={index}>
                                                ...
                                                <td>
                                                    <button style={{ backgroundColor: 'white', color: '#cb297b', boxShadow: '0px 0px 10px #00000029' }} type='button' onClick={() => navigate(`/nurse_add_diagnose?uhId=${item.UHID}&deviceId=${item.deviceId}&_id=${item._id}`)}
