...
export default function Device() {
  ...
  const handleAssign = (e) => {
    e.preventDefault();
    history('/deviceAssign?DeviceId=${code}')
  }
  return (
    <div>
      <NavBarForAll />
                                        ...
                                        <section className={Style.tableBody}>
                                          ...
                                          >
                                            <div class="px-4 py-1" style={{ padding: '1px', margin: '1px' }}>
                                              {adminProfile == 'User' || adminProfile == 'Hospital-Admin' ?
                                                ...
                                                item && item.deviceInfo && item.deviceInfo.length > 0 ?
                                                  <>
                                                    <span class="block text-sm text-gray-900 dark:text-white">
                                                      <button title='Edit'
                                                        onClick={(e) => {
                                                          setModalShow1(true);
                                                          dispatch(getSingleDeviceIdDetails(item.deviceId))
                                                          { localStorage.setItem('item1', JSON.stringify(item)) }
                                                        }} style={{ width: '8rem', backgroundColor: '#cb297b' }} class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Edit</button>
                                                      <UpdateDetailsModal
                                                        show={modalShow1}
                                                  ...
                                                  <span class="block text-sm text-gray-900 dark:text-white">
                                                    <button
                                                      ...
                                                      }} style={{ width: '8rem', backgroundColor: '#cb297b' }}
