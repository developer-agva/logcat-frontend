        ...
        <div style={{ marginTop: '5rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "1rem", }}>
                        ...
                        <h1 class="flex items-center text-3xl font-extrabold" style={{ justifyContent: 'center' }}>View<span class="bg-rgb(203, 41, 123)-100 text-rgb(203, 41, 123)-800 text-2xl font-semibold mr-2 px-0 py-0.5 rounded   ml-2">Dosage</span></h1>
                    </div>
                    <div>
