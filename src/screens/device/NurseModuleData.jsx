...
function NurseModuleData() {
  ...
  const { loading, data, error } = getPatientDiagnose;
        ...
        <div class="relative overflow-x-auto">
          <table class="w-full text-sm text-left text-gray-500 :text-gray-400">
            ...
            {getAllTicket && getAllTicket.length > 0 ? (
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td
                        ...
                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap text-center"
                      >
                        {item.dateTime ? item.dateTime.split("T")[0] : "---"}
                      </td>
                      <td
                        scope="row"
                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap text-center"
                      >
                        {item.stats ? item.stats?.[0]?.statsData : "---"}:{item.stats ? item.stats?.[0]?.statsValue : "---"}
                      </td>
                      <td
                        scope="row"
                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap text-center"
                      >
                      <Link to={item?.report} style={{color:'blue'}}>
                        View Report
                      </Link>
                      </td>
                    </tr>
              ...
              >
                {error && <div class="px-8 py-8">{error}</div>}
