...
console.log('activeApnia',activeApnia)
                ...
                <div style={{ display: 'flex', gap: '4rem', flexWrap: 'wrap', backgroundColor: 'white', width: '85%', padding: '20px 40px', margin: '5px' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                            ...
                            <div style={{ width: '120px', height: '120px', backgroundColor: 'black', borderRadius: '90px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                {/* <div Style={activeAdvance==='false'?{backgroundColor:'black'}:{backgroundColor:'green'}} style={{ width: '100px', height: '100px', borderRadius: '90px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}> <span style={{ color: 'white' }}>{activeAdvance==='false'?'INACTIVE':'ACTIVE'}</span></div> */}
                                <div style={activeAdvance==='false'?{backgroundColor:'black', width: '100px', height: '100px', borderRadius: '90px', display: 'flex', justifyContent: 'center', alignItems: 'center'}:{backgroundColor:'green', width: '100px', height: '100px', borderRadius: '90px', display: 'flex', justifyContent: 'center', alignItems: 'center'}}> <span style={{ color: 'white' }}>{activeAdvance==='false'?'INACTIVE':'ACTIVE'}</span></div>
                ...
                advancedText == 3 ?
                    <div style={{ display: 'flex', gap: '4rem', flexWrap: 'wrap', backgroundColor: 'white', width: '85%', padding: '20px 40px', margin: '5px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                            ...
                            <div style={{ width: '120px', height: '120px', backgroundColor: 'black', borderRadius: '90px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                <div style={activeApnia==='false'?{backgroundColor:'black', width: '100px', height: '100px', borderRadius: '90px', display: 'flex', justifyContent: 'center', alignItems: 'center'}:{backgroundColor:'green', width: '100px', height: '100px', borderRadius: '90px', display: 'flex', justifyContent: 'center', alignItems: 'center'}}> <span style={{ color: 'white' }}>{activeApnia==='false'?'INACTIVE':'ACTIVE'}</span></div>
                            </div>
                        </div>
