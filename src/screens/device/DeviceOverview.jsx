      ...
      >
        ...
        >
          ...
          <div className="d-flex" style={{alignItems:'center', flexWrap:'wrap',width:'70%'}}>
            <div className="container" style={{ display: "flex", flexDirection: "row", justifyContent:'space-between', width: "100%", boxShadow: "0px 0px 50px #00000029", borderRadius: "15px", padding: "1rem", marginLeft: "0px" }}>
