...
function DeviceOverview() {
  ...
  useEffect(() => {
    dispatch(getSingleDeviceIdDetails(deviceid,projectCode));
  }, [dispatch]);
  ...
  const handleBackBtn = () => {
    if (adminProfile == "User") {
      ...
      history(
        `/newDevice?code=${code}&name=${projectName}&projectCode=${projectCode}&page=${page}`
      );
    } else {
        ...
        >
          ...
          >
            ...
            >
              ...
              {projectCode === "003" || projectCode === "004" || projectCode==="007" ? (
                <Link
