                                                ...
                                                return (
                                                    <tr key={index} class="bg-white border-b">
                                                        ...
                                                        <td class="px-6 py-4 text-center">
                                                            <select
                                                                style={item1.ticketStatus === 'Closed' ? { width: '7rem', backgroundColor: '#E2FFE1', color: '#04A700', padding: '10px', borderRadius: '8px' } : item1.ticketStatus === 'Open' ? { width: '7rem', backgroundColor: '#FFF0F1', color: '#FF4B4E', padding: '10px', borderRadius: '2px', borderRadius: '8px' } : { width: '7rem', backgroundColor: '#FFF4CC', color: 'black', padding: '10px', borderRadius: '2px', borderRadius: '8px' }}
                                                                onChange={(e) => {
