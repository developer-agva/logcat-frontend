                ...
                >
                    ...
                    >
                        ...
                        <div style={{ position: 'fixed', right: '3rem', bottom: '3rem', zIndex: '2' }}>
                            <button onClick={() => { history('/supportForm') }} style={{ backgroundColor: 'rgb(203, 41, 123)', color: 'white', padding: '20px', borderRadius: '80px' }}>
                                <Link
                                    to="/supportForm"
                        ...
                        <>
                            <div class="relative overflow-x-auto shadow-md sm:rounded-lg" style={{ borderRadius: '1.5rem' }}>
                                <div style={{ backgroundColor: '#cb297b' }}>
                                    <form>
                                ...
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                        <tr>
                                            <td scope="col" class="text-center text-white text-3xl font-medium" style={{ backgroundColor: '#cb297b' }}>
                                                Ticket Number
                                            </td>
                                            <td scope="col" class="text-center text-white text-3xl font-medium" style={{ backgroundColor: '#cb297b' }}>
                                                Date
                                                ...
                                                return (
                                                    <tr class="bg-white border-b hover:bg-gray-50">
                                                        ...
                                                        {/* <td class="px-6 py-4 text-center">
                                                                {item1.date ? item1.date.split(' ')[1] : 'NA'}
                                                        </td> */}
                                                        <td class="px-6 py-4 text-center "
                                                        >
