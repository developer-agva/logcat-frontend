...
import { changeTicketStatusAction, deleteStatusDataAction, getAllTicketsDataAction, getServicesDataAction, postReAssignList } from '../../../store/action/ServiceEngAction';
                                                ...
                                                return (
                                                    <tr key={index} class="bg-white border-b">
                                                        <td class="px-6 py-4 text-center" style={{ cursor: 'pointer', fontWeight: 'bolder' }}>
                                                            <Link to={`/Ticket_details?ticket=${item1 && item1.ticket_number}`} style={{ textDecoration: "none", color: 'black' }}>
                                                                {item1.ticket_number ? item1.ticket_number : 'NA'}
                                                            </Link>
                                                        </td>
                                                        <td class="px-6 py-4 text-center text-lg-center" style={{ fontWeight: 'bolder' }}>
                                                            {item1?.ticketInfo?.hospital_name ? item1?.ticketInfo?.hospital_name : '---'}
                                                        </td>
                                                        <td class="px-6 py-4 text-center text-lg-center" style={{ width: '10px' }}>
                                                            {item1.email ? item1.email : 'NA'}
                                                        </td>
                                                        <td class="px-6 py-4 text-center text-lg-center w-16">
                                                            {item1?.message}
                                                        </td>
                                                        <td class="px-6 py-4 text-center text-lg-center w-4" style={{ fontWeight: 'bolder' }}>
                                                            {item1?.ticketInfo?.service_engineer ? item1?.ticketInfo?.service_engineer : '---'}
                                                        </td>
                                                        <td class="px-6 py-4 text-center">
                                                            <select
                                                                style={item1.ticketStatus === 'Closed' ? { width: '7rem', backgroundColor: '#A9A9A9', color: 'white', padding: '10px', borderRadius: '8px' } : item1.ticketStatus === 'Open' ? { width: '7rem', backgroundColor: '#FFF0F1', color: '#FF4B4E', padding: '10px', borderRadius: '2px', borderRadius: '8px' } : { width: '7rem', backgroundColor: '#FFF4CC', color: 'black', padding: '10px', borderRadius: '2px', borderRadius: '8px' }}
                                                                onChange={(e) => {
                                                                    if (item1?.ticket_number) {
                                                                        let ticket_number = item1?.ticket_number
                                                                ...
                                                                <option class="py-2 text-sm text-gray-700 dark:text-gray-200">{item1.ticketStatus}</option>
                                                                {item1.ticketStatus == 'Closed' ?
                                                                    <>
                                                                        <option class="py-2 text-sm text-gray-700 dark:text-gray-200" value='Hold'>Hold</option>
                                                                        <option class="py-2 text-sm text-gray-700 dark:text-gray-200" value='Open'>Open</option>
                                                                    </> :
                                                                    item1.ticketStatus == 'Open' ?
                                                                        <>
                                                                            <option class="py-2 text-sm text-gray-700 dark:text-gray-200" value='Hold'>Hold</option>
                                                                            <option class="py-2 text-sm text-gray-700 dark:text-gray-200" value='Closed'>Closed</option>
                                                                        </>
                                                                        :
                                                                        <>
                                                                            <option class="py-2 text-sm text-gray-700 dark:text-gray-200" value='Closed'>Closed</option>
                                                        ...
                                                        <td class="px-6 py-4 text-center justify-center">
                                                            {item1?.ticketStatus === 'Closed' ?
                                                                <button disabled style={{ backgroundColor: '#98004c', color: 'white', padding: '14px', borderRadius: '8px', cursor: 'not-allowed' }}
                                                                >Assign</button>
                                                                :
                                                                <button style={{ backgroundColor: '#98004c', color: 'white', padding: '14px', borderRadius: '8px' }} onClick={() => {
                                                                    (props.setOpenModal('defaultData'))
                                                                    setAssignDetails(serviceEngDataa)
                                                                    setCheckBoxEmail({ ...checkboxEmail, id: item1.ticket_number })

                                                                }
                                                                }>Assign</button>
                                                            }
                                                            <Modal show={props.openModal === 'defaultData'} onClose={() => props.setOpenModal(undefined)}>
                                                                <Modal.Header style={{ padding: '1rem' }}>Assign Engineer</Modal.Header>
                                                                <Modal.Body>
