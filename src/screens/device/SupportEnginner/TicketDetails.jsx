...
function TicketDetails() {
    ...
    const handleSubmit = useCallback((e) => {
        ...
        if (!remarks) {
            ...
            const serviceEngName = allTicketDataGet?.serviceEngName ? allTicketDataGet?.serviceEngName : 'NA';
            const contactNo = allTicketDataGet?.contactNo;
            dispatch(postServiceTicketStatus(_id, contactNo, serviceEngName))
    ...
    const handleVerifyOtp = useCallback(() => {
        if (!state.otp) {
          return  alert('Enter Otp')
            ...
            dispatch(getVerifiedOtpServiceAction(otp, deviceId, remarks))
    ...
    return (
        <div>
            ...
            <div className="p-3">
                ...
                <h4 className="text-xl  font-bold :text-white">Ticket Details</h4>
                ...
                <div style={{ textDecoration: 'none', width: '100%', gap: '1rem', display: 'flex', flexDirection: 'row' }} className="block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 :bg-gray-800 :border-gray-700 :hover:bg-gray-700">
                    <div style={{ textDecoration: 'none', width: '100%', gap: '1rem', display: 'flex', flexDirection: 'column' }}>
                        ...
                        <p className="font-normal text-gray-700 flex">
                            Ticket Status :
                            <button style={allTicketDataGet?.ticketStatus == 'Open' ? { backgroundColor: '#FFBF00', color: 'black', width: '6vw', height: '2.5vw', borderRadius: '5px' } : { borderRadius: '5px', backgroundColor: '#AC0303', color: 'white', padding: '8px', width: '6vw', height: '2.5vw', }}
                                onClick={() => {
                                    (allTicketDataGet?.ticketStatus == 'Open' ? props.setOpenModal('default') : props.setOpenModal('defaults'))
                                    // setDetailsData(allTicketDataGet?)
                                        ...
                                        <div style={{ display: 'flex', padding: '5px', justifyContent: 'space-between' }}>
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                                ...
                                                <div>
                                                    ...
                                                    <p>
                                                        {allTicketDataGet?.ticketInfo?.hospital_name}
                                                    </p>
