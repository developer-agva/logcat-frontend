                    ...
                    <form >
                        <div>
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2" style={{ textAlign: 'start' }}>
                                <div>
                                    ...
                                    {dispatchDetails && dispatchDetails.deviceId.length > 0 ?
                                        <input id='arrow' value={serialNoData && serialNoData.serialNumber} disabled
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter Serial Number" />
                                        :
                                        <>
                                ...
                                {dispatchDetails.serialNumber.length > 0 ?
                                    <div style={(serialNoData && serialNoData.deviceId && serialNoData.deviceId.length > 0) ? { padding: '0.6rem' } : { padding: '0.6rem' }} id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500">
                                ...
                                <input type="number" onChange={(e) => {
                                    ...
                                    value={dispatchDetails.pincode} id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter PinCode"  />
                                </>
                                }
                            </div> */}
                                {serialNoData?.hospitalName?.length > 0 ?
                                    <div>
                                        <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 ">Hospital Name <span>*</span></label>
                                        <div style={(serialNoData && serialNoData.dateOfWarranty && serialNoData.dateOfWarranty.length > 0) ? { padding: '0.6rem' } : { padding: '1.2rem' }} id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500">
                                    ...
                                    <div>
                                        ...
                                        <input list="hospitalData" type="text"
                                            ...
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter Hospital Name" />
                                ...
                                <div >
                                    ...
                                    <input list="nameList" onChange={(e) => setDispatchDetails({ ...dispatchDetails, service_engineer: e.target.value })} id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter Service Enginner Name" />
                                ...
                                <div>
                                    ...
                                    <select onChange={(e) => setDispatchDetails({ ...dispatchDetails, tagName: e.target.value })}
                                        value={dispatchDetails.tagName} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500" >
                                ...
                                {/* Department */}
                                <div>
                                    <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 ">Department Name</label>
                                ...
                                {/* Warrenty Status */}
                                <div>
                                    <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 ">Warranty Status</label>
                                    <div style={(serialNoData && serialNoData.dateOfWarranty && serialNoData.dateOfWarranty.length > 0) ? { padding: '0.6rem' } : { padding: '1.2rem' }} id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    }} value={dispatchDetails.nameConcernedPerson} id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter Concerned Person Name" />
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        <input type="text" onChange={(e) => {
                                            ...
                                            value={dispatchDetails.emailConcernedPerson} id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter Concerned Person Email" />
                                        {/* {verifyBtn === 'Verified' ?
                                            ...
                                            <Modal.Body>
                                                <div className="text-center">
                                                    <div class="mb-6">
                                                        ...
                                                        <label htmlFor="large-input" class="block mb-2 text-sm font-medium text-gray-900 dark">Enter OTP Code</label>
                                ...
                                <div>
                                    ...
                                    }} value={dispatchDetails.contactNo} id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter Concerned Person Contact" />
                                ...
                                <div>
                                    ...
                                    <select class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500" onChange={(e) => setDispatchDetails({ ...dispatchDetails, priority: e.target.value })} value={dispatchDetails.priority}>
                            ...
                            <div>
                                ...
                                <div class="flex gap-2 mb-6 md:grid-cols-2" style={{ alignItems: 'center' }}>
                                    <input type="file" onChange={handleImageSelect} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500" />
                        ...
                        <div className={Style.rightForm}>
                            <div className={Style.formItem}>
                                <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 ">Concerned Person Details</label>
