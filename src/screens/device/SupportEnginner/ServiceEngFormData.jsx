...
import { verifyOtpForSuppport } from '../../../store/action/VerifiedEmail';
    ...
    const dispatchHandler = (e) => {
        ...
        if (!!ticketNo) {
            ...
            dispatch(putallStoreDataAction({
                ...
                hospitalName: dispatchDetails?.hospitalNamee.length > 0 ? dispatchDetails?.hospitalNamee : serialNoData?.hospitalName,
                // hospitalName:dispatchDetails?.hospitalNamee,
                ...
                location: location,
                // pincode: dispatchDetails?.pincode.length > 0 ? dispatchDetails?.pincode : serialNoData?.pincode,
                ...
                <form >
                    <div>
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2" style={{ textAlign: 'start' }}>
                            <div>
                                ...
                                {dispatchDetails && dispatchDetails.deviceId.length > 0 ?
                                    <input id='arrow' value={serialNoData && serialNoData.serialNumber} disabled
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter Serial Number"  />
                                    :
                                    <>
                                        ...
                                        <datalist id='serialno'>
                                            {dataSerialNumbers && dataSerialNumbers.data && dataSerialNumbers.data.map((item,index) => {
                                                return (
                            ...
                            {/* pin code */}
                            {/* <div>
                                <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Pin Code</label>
                                ...
                                <input type="number" onChange={(e) => {
                                    ...
                                    value={dispatchDetails.pincode} id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter PinCode"  />
                                </>
                                }
                            </div> */}
                            {serialNoData?.hospitalName?.length > 0 ?
                                <div>
                                    <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Hospital Name</label>
                                    <div style={(serialNoData && serialNoData.dateOfWarranty && serialNoData.dateOfWarranty.length > 0) ? { padding: '0.6rem' } : { padding: '1.2rem' }} id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500">
                                        {serialNoData?.hospitalName.length > 0 ? serialNoData?.hospitalName : ''}
                                    </div>
                                </div>
                                :
                                <div>
                                    ...
                                    onChange={(e) => { setDispatchDetails({ ...dispatchDetails, hospitalNamee: e.target.value }) }}
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter Hospital Name"  />
                            ...
                            <div >
                                <label htmlFor="first_name" style={{ textAlign: 'start' }} class="block mb-2 text-sm font-medium text-gray-900 :text-white">Service Engineer</label>
                                <input list="nameList" onChange={(e) => setDispatchDetails({ ...dispatchDetails, service_engineer: e.target.value })} id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter Service Enginner Name"  />
                            ...
                            {/* tag name */}
                            <div>
                                <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Select Tag Name</label>
                            ...
                            {/* Department */}
                            <div>
                                <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Department Name</label>
                            ...
                            {/* Warrenty Status */}
                            <div>
                                <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Warranty Status</label>
                                <div style={(serialNoData && serialNoData.dateOfWarranty && serialNoData.dateOfWarranty.length > 0) ? { padding: '0.6rem' } : { padding: '1.2rem' }} id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500">
                            ...
                            {/* nameConcernedPerson */}
                            <div>
                                <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Concerned Person Name</label>
                                <input list='concernedName' type="text" onChange={(e) => {
                                    setDispatchDetails({ ...dispatchDetails, nameConcernedPerson: e.target.value })
                                }} value={dispatchDetails.nameConcernedPerson} id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter Concerned Person Name"  />
                            ...
                            <div>
                                <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Concerned Person Email</label>
                                <div class="flex items-center">
                                    <input type="text" onChange={(e) => {
                                        ...
                                        value={dispatchDetails.emailConcernedPerson} id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter Concerned Person Email"  />
                                    {/* {verifyBtn === 'Verified' ?
                                        ...
                                        <Modal.Body>
                                            <div className="text-center">
                                                <div class="mb-6">
                                                    ...
                                                    <label htmlFor="large-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter OTP Code</label>
                            ...
                            <div>
                                <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Contact Number</label>
                                <input list='concernedNumber' type="text" onChange={(e) => {
                                    setDispatchDetails({ ...dispatchDetails, contactNo: e.target.value })
                                }} value={dispatchDetails.contactNo} id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500" placeholder="Enter Concerned Person Contact"  />
                            ...
                            <div>
                                <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Priority</label>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', padding: '1rem', boxShadow: "rgba(0, 0, 0, 0.16) 0px 1px 4px", borderRadius: '10px' }}>
                                        <div>
                                            ...
                                            <div class="flex items-start mb-6">
                                                <div class="flex items-center h-5">
                                                    <input
                                                        onChange={handleCheckboxChange} id="remember" type="checkbox" value='Request htmlFor Consumables' class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800"  />
                                                </div>
                                                <label htmlFor="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Request htmlFor Consumables</label>
                                            </div>
                                            <div class="flex items-start mb-6">
                                                <div class="flex items-center h-5">
                                                    <input
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-start mb-6">
                                                <div class="flex items-center h-5">
                                                    <input
                                                        onChange={handleCheckboxChange} id="remember" type="checkbox" value='Apply htmlFor CMC/AMC' class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800"  />
                                                </div>
                                                <label htmlFor="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Apply htmlFor CMC/AMC</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-2 mb-6 md:grid-cols-2" style={{ alignItems: 'center' }}>
                                <input type="file" onChange={handleImageSelect} id="confirm_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500"  />
                    ...
                    <div className={Style.rightForm}>
                        <div className={Style.formItem}>
                            <label htmlFor="company" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Concerned Person Details</label>
