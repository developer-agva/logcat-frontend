...
function ServiceEngFormData() {
    ...
    const dispatchHandler = () => {
        ...
        console.log('123', issuesData?.name?.length > 0 ? issuesData?.name : allTicketDataGet?.name)
        console.log(allTicketDataGet)
        if (!!ticketNo) {
            ...
            dispatch(putallStoreDataAction({
                ...
                name: issuesData?.name?.length > 0 ? issuesData?.name : allTicketDataGet?.name,
                ...
                email: issuesData?.email?.length > 0 ? issuesData?.name : allTicketDataGet?.email,
                department: issuesData?.department?.length > 0 ? issuesData?.name : allTicketDataGet?.department,
                contactNo: issuesData?.contactNo?.length > 0 ? issuesData?.name : allTicketDataGet?.contactNo,
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2" style={{ textAlign: 'start' }}>
                                ...
                                <div>
                                    ...
                                    <input id='arrow' onChange={(e) => setIssuesData({ ...issuesData, name: e.target.value })} value={issuesData?.name}
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter Name" required />
                                </div>
                                <div>
                                    ...
                                    <input id='arrow' onChange={(e) => setIssuesData({ ...issuesData, email: e.target.value })} value={issuesData?.email}
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter Email" required />
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input id='arrow' onChange={(e) => setIssuesData({ ...issuesData, contactNo: e.target.value })} value={issuesData?.contactNo}
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter Contact Number" required />
                                </div>
                                <div>
                                    ...
                                    <input id='arrow' onChange={(e) => setIssuesData({ ...issuesData, department: e.target.value })} value={issuesData?.department}
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter Department Name" required />
                                </div>
