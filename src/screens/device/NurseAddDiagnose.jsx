...
import { getIndianMedicineAction, postPatientDataAction } from '../../store/action/DeviceAction';
...
function NurseAddDiagnose() {
    ...
    const generatePdfAndUploadToS3 = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.REACT_APP_BASE_URL}/patient/upload-patient-file/${deviceId}/${patientData?.uhid}`, formData,
                {
        ...
        <div>
            ...
            <form className="p-3">
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="first_name" className="block mb-2 text-sm font-medium text-gray-900 :text-white">UHID<span>*</span></label>
                        <input
                            onChange={(e) => {
                                setPatientData({ ...patientData, uhid: e.target.value })
                            }}
                            value={patientData.uhid}
                            type="text" id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter UHID" required />
                        {/* } */}
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            type="text" id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter Device Id" required />
                    </div>
                    <div>
