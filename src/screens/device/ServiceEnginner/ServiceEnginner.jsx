    ...
    return (
        <>
            <div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', backgroundColor: 'white', boxShadow: 'rgba(0, 0, 0, 0.16) 0px 1px 4px',padding: '12px', position: 'relative', top:'20px',bottom: '30px', height: '70px', margin: "0px 10px",borderRadius:'10px' }}>
