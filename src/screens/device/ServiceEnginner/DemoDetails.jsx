...
const DemoDetails = () => {
  ...
  const handleSubmit = useCallback((e) => {
    e.preventDefault();
    const { deviceId, contactNo, hospitalName, demoDuration, priority, description } = demoData;
    ...
    dispatch(postDemoAddDataAction({ deviceId, contactNo, hospitalName, demoDuration, priority, description }));
  }, [demoData, dispatch]);
    ...
    <div>
      ...
      <form className="px-4 flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <div className="py-4 flex justify-center">
          <button
            type="submit"
            className="px-4 py-2 text-white rounded-lg w-full md:w-1/2" style={{backgroundColor:'rgb(203, 41, 123)'}}
          >
            Submit
          </button>
        </div>
