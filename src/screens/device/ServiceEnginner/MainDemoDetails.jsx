            ...
            <div class="p-4" style={{ marginTop: "3rem" }}>
                <div class="px-2 py-3">
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        ...
                        <button style={{ padding: '10px', border: '1px solid rgb(203, 41, 123)', color: 'rgb(203, 41, 123)', borderRadius: '12px', width: '8rem' }} onClick={() => navigate('/main_demo_details')}>Add Demo</button>
                    </div>
                    <div style={{ marginTop: "1rem", display: 'flex', gap: '10px' }}>
                        ...
                        <button onClick={handleClickSearch} className='px-2' style={{ backgroundColor: 'rgb(203, 41, 123)', color: 'white', borderRadius: '10px' }}>
                            Search
                        </button>
                    </div>
                    <div>
