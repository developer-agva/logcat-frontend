...
function MarketingHeadScreen() {
    ...
    return (
        <div>
            <div style={{ display: 'flex', marginTop: '1rem', alignItems: 'center',flexWrap:'wrap' }}>
                ...
                <Link to='/allDataInMarketing' class="block p-8 bg-white border border-gray-200 rounded-lg shadow text-decoration-none" style={{ width: '350px', height: '150px', margin: '2rem', display: 'flex', gap: '1rem', alignItems: 'center' ,justifyContent:'center'}}>
                        <h5 style={{ marginBottom: '0.5rem' }} class=" text-2xl tracking-tight text-gray-900">All Data</h5>
                </Link>
            </div>
        </div>
    )
