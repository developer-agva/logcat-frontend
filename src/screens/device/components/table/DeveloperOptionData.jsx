...
import { getDeveloperOptionData } from '../../../../store/action/DeviceAction';
import back from "../../../../assets/images/back.png";
import { CSVLink } from "react-csv";
export default function DeveloperOptionData() {
  const getDeveloperOptionDataReducer = useSelector((state) => state.getDeveloperOptionDataReducer);
  const { loading, data ,error} = getDeveloperOptionDataReducer;

  let eventsFilter = data && data.data;
  ...
  useEffect(() => {
    dispatch(getDeveloperOptionData({ page: 1, limit: recordsPerPage, did }));
  },[])
  return (
        <>
  ...
  function prePage() {
    dispatch(getDeveloperOptionData({ page: incPage - 1, limit: recordsPerPage }))
  }
