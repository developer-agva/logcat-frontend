                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2" style={{ textAlign: 'start' }}>
                            ...
                            <div>
                                ...
                                <input type="date" onChange={(e) => setDispatchDetails({ ...dispatchDetails, manufacturingDate: e.target.value })}
                                    value={dispatchDetails.manufacturingDate} id="visitors" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400  :focus:ring-blue-500 :focus:border-blue-500" required />
                            </div>
                            <div>
