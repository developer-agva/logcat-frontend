            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="p-6 bg-white rounded-lg shadow-md">
                  ...
                  <p className="text-2xl font-semibold">{attendanceLogs?.totalEmployees}</p>
                </div>
                <div className="p-6 bg-white rounded-lg shadow-md">
                  <h2 className="text-xl font-bold mb-2">Present Employees</h2>
                  <p className="text-2xl font-semibold">{attendanceLogs?.totalPresent}</p>
                </div>
              </div>
            </div>
          </>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded shadow col-span-2">
            ...
            <div className="flex gap-4 mb-4">
              ...
              <div className="flex gap-2 items-center">
                <span className="bg-black text-black" style={{ width: '10px', height: '10px', borderRadius: '10px', fontSize: '5px' }}>1</span>
                <p>Leave Applied</p>
              </div>
            </div>
