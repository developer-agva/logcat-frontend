...
import { deleteLeaveCompoffAction, deleteLeaveRequestAction, getCompoffDataAction, getEmployeLeaveStatusAction, getUserDataAction } from "../store/action/userDataAction";
                    ...
                    <tbody>
                        {dataa1?.data?.map((item, index1) => {
                            return (
                                ...
                                >
                                    ...
                                    <td>
                                        {item.status === 'Pending' ?
                                            <button className="px-2 py-2 bg-blue-600 text-black text-white rounded" onClick={() => { dispatch(deleteLeaveCompoffAction({ id: item?._id })) }}>Delete</button>
                                            : '--'}
                                    </td>
                                </tr>
                            )
                        ...
                        {filteredLeaveData?.map((leave, index) => (
                            ...
                            >
                                ...
                                <td className="px-6 py-6 text-black text-start">{leave?.reason}</td>
                                <td className="px-6 py-6 text-black text-start">
