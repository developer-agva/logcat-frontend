...
const CreateProjectModal = ({ tittleBtn }) => {
        ...
        switch (leaveData.leaveType) {
            ...
            case "earnedLeave":
                ...
                if (leaveData.totalDays < 1 || leaveData.totalDays > 14) {
                    setLeaveError((prevErrors) => ({
                        ...prevErrors,
                        earned: 'Earned leave must be applied for a minimum of 1 day and a maximum of 14 days.', // Update the `medical` field
                    }));
                    return
    ...
    const getMinDateForLeaveType = () => {
        ...
        switch (leaveData.leaveType) {
            ...
            case "earnedLeave":
                return formatDate(currentDate); // Can apply starting today
            default:
        ...
        switch (leaveData.leaveType) {
            ...
            case "earnedLeave":
                ...
                if (leaveData.startDate) {
                    ...
                    maxDurationDate.setDate(startDate.getDate() + 13); // Add 6 days to start date
                    return formatDate(
    ...
    const handleSubmit = (e) => {
        ...
        switch (leaveData.leaveType) {
            ...
            case "earnedLeave":
                ...
                // if (leaveData.totalDays < 1 || leaveData.totalDays > 14) {
                //     updatedErrors.earned = 'Earned leave must be applied for a minimum of 1 day and a maximum of 14 days.';
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-lg relative z-10 p-6">
                        ...
                        <form className="mt-4 space-y-4" onSubmit={handleSubmit}>
                            ...
                            {leaveData.startDate === formattedDate && leaveData.leaveType === 'casualLeave' || leaveData.leaveType === 'earnedLeave' ?
                                <div>
                                    <label
                                        htmlFor="startDate"
                                        className="block text-sm font-medium text-gray-700"
